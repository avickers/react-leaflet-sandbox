...
class App extends Koc {
  ...
  fluid() {
    ...
    const w = this.shadowRoot.querySelector('canvas')
    ...
    */
    const initialize = () => {
      ...
      */
      ...
      this.shadowRoot.querySelector('.container').addEventListener("mousemove", mouse_move_handler);
      this.shadowRoot.querySelector('.container').addEventListener("touchmove", touch_move_handler);
